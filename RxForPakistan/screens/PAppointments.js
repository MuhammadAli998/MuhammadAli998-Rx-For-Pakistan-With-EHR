...
const Appointment = ({ navigation }) => {
  ...
  useEffect(() => {
    fetch(`http://${ip}/DoctorApi/api/Doctor/GetPendingAppointmentsV?doctordb=${doctordb}`)
              ...
              onPress={() =>
                Alert.alert(
                  ...
                  [
                    ...
                    {
                      text: 'Add Vitals ',
                      onPress: () => navigation.navigate('Vitals', {  Aid: appointment[3],doctordb:doctordb}),
                    },
                    {
                      text: 'Add Chief Complaint',
                      onPress: () => navigation.navigate('Disease', {  Aid: appointment[3],doctordb:doctordb}),
                    },
                  ],
                  { cancelable: true },
                )
